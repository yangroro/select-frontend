...
export const requestGetReviews = (
  ...
  params: RequestReviewsParameters,
    ...
    url: `${env.BASE_URL_STORE_API}/api/select/books/${bookId}/reviews`,
    method: 'GET',
    params: decamelize({
      page: params.page,
...
export const requestPostReview = (
  ...
  hasSpoiler: boolean,
    ...
    url: `${env.BASE_URL_STORE_API}/api/select/books/${bookId}/reviews/my/content`,
    method: 'POST',
...
export const requestPostRating = (
  ...
  rating: number,
    ...
    url: `${env.BASE_URL_STORE_API}/api/select/books/${bookId}/reviews/my/rating`,
    method: 'POST',
...
export const requestReportReview = (
  ...
  reason: number,
    ...
    url: `${env.BASE_URL_STORE_API}/api/select/books/${bookId}/reviews/${reviewId}/report`,
    method: 'POST',
...
export const requestLikeReview = (
  ...
  reviewId: number,
    ...
    url: `${env.BASE_URL_STORE_API}/api/select/books/${bookId}/reviews/${reviewId}/like`,
    method: 'POST',
  });
...
export const requestPostComment = (
  ...
  content: TextWithLF,
    ...
    url: `${env.BASE_URL_STORE_API}/api/select/books/${bookId}/reviews/${reviewId}/comments`,
    method: 'POST',
...
export const requestDeleteComment = (
  ...
  commentId: number,
    ...
    url: `${env.BASE_URL_STORE_API}/api/select/books/${bookId}/reviews/${reviewId}/comments/${commentId}`,
    method: 'DELETE',
  });
